...
import com.qardio.museum.databinding.PaginationLoadingStateBinding

/**
 * Adapter to display the loading state of pagination.
 * Load states are Loading, Error, Not Loading
 */
class ArtLoadStateAdapter(private val retry: () -> Unit) : LoadStateAdapter<ArtLoadStateAdapter.ArtLoadStateViewHolder>() {
